/* eslint-disable @next/next/no-img-element -- Local editorial media is pre-sized and loaded explicitly. */
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/terceirizacao" },
  openGraph: {
    title: "Terceirização para o mercado pet | Orion",
    description: "Da direção de marca ao produto final em uma operação conectada.",
    url: "/terceirizacao",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "Processo industrial Orion" }],
  },
};
