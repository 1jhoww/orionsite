...
/**
 * The commercial form, extracted so the /contato route owns it without duplicating
 * validation or the WhatsApp hand-off. Fields, rules, copy and destination unchanged.
 */
  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="contact-form-footer">
        <button className="button button--primary button--whatsapp contact-submit" type="submit">
          <WhatsAppIcon />
